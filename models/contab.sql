...
, rtrim(glbt_Entidad.EntRazonSocial) EntRazonSocial
...
,(select isnull(rtrim(clactanodonombre),'')  from cont_clasificacuentas where ppdcid = $pdcid
  and clactanivel1 = (select clactanivel1 from cont_clasificacuentas where pctaid = ccet_Movimientos.pCtaId  and ppdcid = $pdcid ) 
  and clactanivel2 = 0  and clactanivel3 = 0 and ClaCtaNivel4 = 0 and clactanivel5 = 0 and clactanivel6 = 0
  and clactanivel7 = 0  and (pctaid = 0 or pctaid = ccet_Movimientos.pCtaId ) and clactanodonivel = 1) 
  as clactanodonivel1

, (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas where ppdcid = $pdcid
  and clactanivel1 = (select clactanivel1 from cont_clasificacuentas where pctaid = ccet_Movimientos.pCtaId and ppdcid = $pdcid )
  and clactanivel2 = (select clactanivel2 from cont_clasificacuentas where pctaid = ccet_Movimientos.pCtaId and ppdcid = $pdcid )
  and clactanivel3 = 0 and ClaCtaNivel4 = 0 and clactanivel5 = 0 and clactanivel6 = 0 and clactanivel7 = 0
  and (pctaid = 0 or pctaid = ccet_Movimientos.pCtaId) and clactanodonivel = 2) 
  as clactanodonivel2

, (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas where ppdcid = $pdcid
   and clactanivel1 = (select clactanivel1 from cont_clasificacuentas where pctaid = ccet_Movimientos.pCtaId and ppdcid = $pdcid )
   and clactanivel2 = (select clactanivel2 from cont_clasificacuentas where pctaid = ccet_Movimientos.pCtaId and ppdcid = $pdcid )
   and clactanivel3 = (select clactanivel3 from cont_clasificacuentas where pctaid = ccet_Movimientos.pCtaId and ppdcid = $pdcid )
   and ClaCtaNivel4 = 0 and clactanivel5 = 0 and clactanivel6 = 0 and clactanivel7 = 0
   and (pctaid = 0 or pctaid = ccet_Movimientos.pCtaId) and clactanodonivel = 3) 
   as clactanodonivel3
...
, (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas   where ppdcid = $pdcid
   ...
   and clactanivel2 = (select clactanivel2 from cont_clasificacuentas where pctaid = ccet_Movimientos.pCtaId and ppdcid = $pdcid )
   and clactanivel3 = (select clactanivel3 from cont_clasificacuentas where pctaid = ccet_Movimientos.pCtaId and ppdcid = $pdcid )
   and ClaCtaNivel4 = (select clactanivel4 from cont_clasificacuentas where pctaid = ccet_Movimientos.pCtaId and ppdcid = $pdcid )
   and clactanivel5 = 0 and clactanivel6 = 0  and clactanivel7 = 0  and (pctaid = 0 or pctaid = ccet_Movimientos.pCtaId) and clactanodonivel = 4)
   as clactanodonivel4
...
,  (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas     where ppdcid = $pdcid
        ...
        and clactanivel3 = (select clactanivel3 from cont_clasificacuentas where pctaid = ccet_Movimientos.pCtaId and ppdcid = $pdcid )
        and ClaCtaNivel4 = (select clactanivel4 from cont_clasificacuentas where pctaid = ccet_Movimientos.pCtaId and ppdcid = $pdcid )
        and clactanivel5 = (select clactanivel5 from cont_clasificacuentas where pctaid = ccet_Movimientos.pCtaId and ppdcid = $pdcid )
        and clactanivel6 = 0    and clactanivel7 = 0            and ( pctaid = 0 or pctaid = ccet_Movimientos.pCtaId)           and clactanodonivel = 5 )
        as clactanodonivel5
...
,   (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas    where ppdcid = $pdcid
        ...
        and ClaCtaNivel4 = (select clactanivel4 from cont_clasificacuentas where pctaid = ccet_Movimientos.pCtaId and ppdcid = $pdcid )
        and clactanivel5 = (select clactanivel5 from cont_clasificacuentas where pctaid = ccet_Movimientos.pCtaId and ppdcid = $pdcid )
        and clactanivel6 = (select clactanivel6 from cont_clasificacuentas where pctaid = ccet_Movimientos.pCtaId and ppdcid = $pdcid )
        and clactanivel7 = 0    and (pctaid = 0 or pctaid = ccet_Movimientos.pCtaId)    and clactanodonivel = 6 )
        as clactanodonivel6
...
,       (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas        where ppdcid = $pdcid
        ...
        and clactanivel5 = (select clactanivel5 from cont_clasificacuentas where pctaid = ccet_Movimientos.pCtaId and ppdcid = $pdcid )
        and clactanivel6 = (select clactanivel6 from cont_clasificacuentas where pctaid = ccet_Movimientos.pCtaId and ppdcid = $pdcid )
        and clactanivel7 = (select clactanivel7 from cont_clasificacuentas where pctaid = ccet_Movimientos.pCtaId and ppdcid = $pdcid )
        and (pctaid = 0 or pctaid = ccet_Movimientos.pCtaId)
        and clactanodonivel = 7 )
        as clactanodonivel7
...
,(select isnull(rtrim(clactanodonombre),'')  from cont_clasificacuentas where ppdcid = $pdcid
  and clactanivel1 = (select clactanivel1 from cont_clasificacuentas where pctaid = cont_Movimientos.pCtaId  and ppdcid = $pdcid ) 
  and clactanivel2 = 0  and clactanivel3 = 0 and ClaCtaNivel4 = 0 and clactanivel5 = 0 and clactanivel6 = 0
  and clactanivel7 = 0  and (pctaid = 0 or pctaid = cont_Movimientos.pCtaId ) and clactanodonivel = 1) 
  as clactanodonivel1

, (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas where ppdcid = $pdcid
  and clactanivel1 = (select clactanivel1 from cont_clasificacuentas where pctaid = cont_Movimientos.pCtaId and ppdcid = $pdcid )
  and clactanivel2 = (select clactanivel2 from cont_clasificacuentas where pctaid = cont_Movimientos.pCtaId and ppdcid = $pdcid )
  and clactanivel3 = 0 and ClaCtaNivel4 = 0 and clactanivel5 = 0 and clactanivel6 = 0 and clactanivel7 = 0
  and (pctaid = 0 or pctaid = cont_Movimientos.pCtaId) and clactanodonivel = 2) 
  as clactanodonivel2

, (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas where ppdcid = $pdcid
   and clactanivel1 = (select clactanivel1 from cont_clasificacuentas where pctaid = cont_Movimientos.pCtaId and ppdcid = $pdcid )
   and clactanivel2 = (select clactanivel2 from cont_clasificacuentas where pctaid = cont_Movimientos.pCtaId and ppdcid = $pdcid )
   and clactanivel3 = (select clactanivel3 from cont_clasificacuentas where pctaid = cont_Movimientos.pCtaId and ppdcid = $pdcid )
   and ClaCtaNivel4 = 0 and clactanivel5 = 0 and clactanivel6 = 0 and clactanivel7 = 0
   and (pctaid = 0 or pctaid = cont_Movimientos.pCtaId) and clactanodonivel = 3) 
   as clactanodonivel3
...
, (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas   where ppdcid = $pdcid
   ...
   and clactanivel2 = (select clactanivel2 from cont_clasificacuentas where pctaid = cont_Movimientos.pCtaId and ppdcid = $pdcid )
   and clactanivel3 = (select clactanivel3 from cont_clasificacuentas where pctaid = cont_Movimientos.pCtaId and ppdcid = $pdcid )
   and ClaCtaNivel4 = (select clactanivel4 from cont_clasificacuentas where pctaid = cont_Movimientos.pCtaId and ppdcid = $pdcid )
   and clactanivel5 = 0 and clactanivel6 = 0  and clactanivel7 = 0  and (pctaid = 0 or pctaid = cont_Movimientos.pCtaId) and clactanodonivel = 4)
   as clactanodonivel4
...
,  (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas     where ppdcid = $pdcid
        ...
        and clactanivel3 = (select clactanivel3 from cont_clasificacuentas where pctaid = cont_Movimientos.pCtaId and ppdcid = $pdcid )
        and ClaCtaNivel4 = (select clactanivel4 from cont_clasificacuentas where pctaid = cont_Movimientos.pCtaId and ppdcid = $pdcid )
        and clactanivel5 = (select clactanivel5 from cont_clasificacuentas where pctaid = cont_Movimientos.pCtaId and ppdcid = $pdcid )
        and clactanivel6 = 0    and clactanivel7 = 0            and ( pctaid = 0 or pctaid = cont_Movimientos.pCtaId)           and clactanodonivel = 5 )
        as clactanodonivel5
...
,   (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas    where ppdcid = $pdcid
        ...
        and ClaCtaNivel4 = (select clactanivel4 from cont_clasificacuentas where pctaid = cont_Movimientos.pCtaId and ppdcid = $pdcid )
        and clactanivel5 = (select clactanivel5 from cont_clasificacuentas where pctaid = cont_Movimientos.pCtaId and ppdcid = $pdcid )
        and clactanivel6 = (select clactanivel6 from cont_clasificacuentas where pctaid = cont_Movimientos.pCtaId and ppdcid = $pdcid )
        and clactanivel7 = 0    and (pctaid = 0 or pctaid = cont_Movimientos.pCtaId)    and clactanodonivel = 6 )
        as clactanodonivel6
...
,       (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas        where ppdcid = $pdcid
        ...
        and clactanivel5 = (select clactanivel5 from cont_clasificacuentas where pctaid = cont_Movimientos.pCtaId and ppdcid = $pdcid )
        and clactanivel6 = (select clactanivel6 from cont_clasificacuentas where pctaid = cont_Movimientos.pCtaId and ppdcid = $pdcid )
        and clactanivel7 = (select clactanivel7 from cont_clasificacuentas where pctaid = cont_Movimientos.pCtaId and ppdcid = $pdcid )
        and (pctaid = 0 or pctaid = cont_Movimientos.pCtaId)
        and clactanodonivel = 7 )
        as clactanodonivel7
...
,(select isnull(rtrim(clactanodonombre),'')  from cont_clasificacuentas where ppdcid = $pdcid
  and clactanivel1 = (select clactanivel1 from cont_clasificacuentas where pctaid = cont_DetalleCom.pCtaId  and ppdcid = $pdcid ) 
  and clactanivel2 = 0  and clactanivel3 = 0 and ClaCtaNivel4 = 0 and clactanivel5 = 0 and clactanivel6 = 0
  and clactanivel7 = 0  and (pctaid = 0 or pctaid = cont_DetalleCom.pCtaId ) and clactanodonivel = 1) 
  as clactanodonivel1

, (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas where ppdcid = $pdcid
  and clactanivel1 = (select clactanivel1 from cont_clasificacuentas where pctaid = cont_DetalleCom.pCtaId and ppdcid = $pdcid )
  and clactanivel2 = (select clactanivel2 from cont_clasificacuentas where pctaid = cont_DetalleCom.pCtaId and ppdcid = $pdcid )
  and clactanivel3 = 0 and ClaCtaNivel4 = 0 and clactanivel5 = 0 and clactanivel6 = 0 and clactanivel7 = 0
  and (pctaid = 0 or pctaid = cont_DetalleCom.pCtaId) and clactanodonivel = 2) 
  as clactanodonivel2

, (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas where ppdcid = $pdcid
   and clactanivel1 = (select clactanivel1 from cont_clasificacuentas where pctaid = cont_DetalleCom.pCtaId and ppdcid = $pdcid )
   and clactanivel2 = (select clactanivel2 from cont_clasificacuentas where pctaid = cont_DetalleCom.pCtaId and ppdcid = $pdcid )
   and clactanivel3 = (select clactanivel3 from cont_clasificacuentas where pctaid = cont_DetalleCom.pCtaId and ppdcid = $pdcid )
   and ClaCtaNivel4 = 0 and clactanivel5 = 0 and clactanivel6 = 0 and clactanivel7 = 0
   and (pctaid = 0 or pctaid = cont_DetalleCom.pCtaId) and clactanodonivel = 3) 
   as clactanodonivel3
...
, (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas   where ppdcid = $pdcid
   ...
   and clactanivel2 = (select clactanivel2 from cont_clasificacuentas where pctaid = cont_DetalleCom.pCtaId and ppdcid = $pdcid )
   and clactanivel3 = (select clactanivel3 from cont_clasificacuentas where pctaid = cont_DetalleCom.pCtaId and ppdcid = $pdcid )
   and ClaCtaNivel4 = (select clactanivel4 from cont_clasificacuentas where pctaid = cont_DetalleCom.pCtaId and ppdcid = $pdcid )
   and clactanivel5 = 0 and clactanivel6 = 0  and clactanivel7 = 0  and (pctaid = 0 or pctaid = cont_DetalleCom.pCtaId) and clactanodonivel = 4)
   as clactanodonivel4
...
,  (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas     where ppdcid = $pdcid
        ...
        and clactanivel3 = (select clactanivel3 from cont_clasificacuentas where pctaid = cont_DetalleCom.pCtaId and ppdcid = $pdcid )
        and ClaCtaNivel4 = (select clactanivel4 from cont_clasificacuentas where pctaid = cont_DetalleCom.pCtaId and ppdcid = $pdcid )
        and clactanivel5 = (select clactanivel5 from cont_clasificacuentas where pctaid = cont_DetalleCom.pCtaId and ppdcid = $pdcid )
        and clactanivel6 = 0    and clactanivel7 = 0            and ( pctaid = 0 or pctaid = cont_DetalleCom.pCtaId)           and clactanodonivel = 5 )
        as clactanodonivel5
...
,   (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas    where ppdcid = $pdcid
        ...
        and ClaCtaNivel4 = (select clactanivel4 from cont_clasificacuentas where pctaid = cont_DetalleCom.pCtaId and ppdcid = $pdcid )
        and clactanivel5 = (select clactanivel5 from cont_clasificacuentas where pctaid = cont_DetalleCom.pCtaId and ppdcid = $pdcid )
        and clactanivel6 = (select clactanivel6 from cont_clasificacuentas where pctaid = cont_DetalleCom.pCtaId and ppdcid = $pdcid )
        and clactanivel7 = 0    and (pctaid = 0 or pctaid = cont_DetalleCom.pCtaId)    and clactanodonivel = 6 )
        as clactanodonivel6
...
,       (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas        where ppdcid = $pdcid
        ...
        and clactanivel5 = (select clactanivel5 from cont_clasificacuentas where pctaid = cont_DetalleCom.pCtaId and ppdcid = $pdcid )
        and clactanivel6 = (select clactanivel6 from cont_clasificacuentas where pctaid = cont_DetalleCom.pCtaId and ppdcid = $pdcid )
        and clactanivel7 = (select clactanivel7 from cont_clasificacuentas where pctaid = cont_DetalleCom.pCtaId and ppdcid = $pdcid )
        and (pctaid = 0 or pctaid = cont_DetalleCom.pCtaId)
        and clactanodonivel = 7 )
        as clactanodonivel7
...
,(select isnull(rtrim(clactanodonombre),'')  from cont_clasificacuentas where ppdcid = $pdcid
  and clactanivel1 = (select clactanivel1 from cont_clasificacuentas where pctaid = test_Movimientos.pCtaId  and ppdcid = $pdcid ) 
  and clactanivel2 = 0  and clactanivel3 = 0 and ClaCtaNivel4 = 0 and clactanivel5 = 0 and clactanivel6 = 0
  and clactanivel7 = 0  and (pctaid = 0 or pctaid = test_Movimientos.pCtaId ) and clactanodonivel = 1) 
  as clactanodonivel1

, (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas where ppdcid = $pdcid
  and clactanivel1 = (select clactanivel1 from cont_clasificacuentas where pctaid = test_Movimientos.pCtaId and ppdcid = $pdcid )
  and clactanivel2 = (select clactanivel2 from cont_clasificacuentas where pctaid = test_Movimientos.pCtaId and ppdcid = $pdcid )
  and clactanivel3 = 0 and ClaCtaNivel4 = 0 and clactanivel5 = 0 and clactanivel6 = 0 and clactanivel7 = 0
  and (pctaid = 0 or pctaid = test_Movimientos.pCtaId) and clactanodonivel = 2) 
  as clactanodonivel2

, (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas where ppdcid = $pdcid
   and clactanivel1 = (select clactanivel1 from cont_clasificacuentas where pctaid = test_Movimientos.pCtaId and ppdcid = $pdcid )
   and clactanivel2 = (select clactanivel2 from cont_clasificacuentas where pctaid = test_Movimientos.pCtaId and ppdcid = $pdcid )
   and clactanivel3 = (select clactanivel3 from cont_clasificacuentas where pctaid = test_Movimientos.pCtaId and ppdcid = $pdcid )
   and ClaCtaNivel4 = 0 and clactanivel5 = 0 and clactanivel6 = 0 and clactanivel7 = 0
   and (pctaid = 0 or pctaid = test_Movimientos.pCtaId) and clactanodonivel = 3) 
   as clactanodonivel3
...
, (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas   where ppdcid = $pdcid
   ...
   and clactanivel2 = (select clactanivel2 from cont_clasificacuentas where pctaid = test_Movimientos.pCtaId and ppdcid = $pdcid )
   and clactanivel3 = (select clactanivel3 from cont_clasificacuentas where pctaid = test_Movimientos.pCtaId and ppdcid = $pdcid )
   and ClaCtaNivel4 = (select clactanivel4 from cont_clasificacuentas where pctaid = test_Movimientos.pCtaId and ppdcid = $pdcid )
   and clactanivel5 = 0 and clactanivel6 = 0  and clactanivel7 = 0  and (pctaid = 0 or pctaid = test_Movimientos.pCtaId) and clactanodonivel = 4)
   as clactanodonivel4
...
,  (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas     where ppdcid = $pdcid
        ...
        and clactanivel3 = (select clactanivel3 from cont_clasificacuentas where pctaid = test_Movimientos.pCtaId and ppdcid = $pdcid )
        and ClaCtaNivel4 = (select clactanivel4 from cont_clasificacuentas where pctaid = test_Movimientos.pCtaId and ppdcid = $pdcid )
        and clactanivel5 = (select clactanivel5 from cont_clasificacuentas where pctaid = test_Movimientos.pCtaId and ppdcid = $pdcid )
        and clactanivel6 = 0    and clactanivel7 = 0            and ( pctaid = 0 or pctaid = test_Movimientos.pCtaId)           and clactanodonivel = 5 )
        as clactanodonivel5
...
,   (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas    where ppdcid = $pdcid
        ...
        and ClaCtaNivel4 = (select clactanivel4 from cont_clasificacuentas where pctaid = test_Movimientos.pCtaId and ppdcid = $pdcid )
        and clactanivel5 = (select clactanivel5 from cont_clasificacuentas where pctaid = test_Movimientos.pCtaId and ppdcid = $pdcid )
        and clactanivel6 = (select clactanivel6 from cont_clasificacuentas where pctaid = test_Movimientos.pCtaId and ppdcid = $pdcid )
        and clactanivel7 = 0    and (pctaid = 0 or pctaid = test_Movimientos.pCtaId)    and clactanodonivel = 6 )
        as clactanodonivel6
...
,       (select isnull(rtrim(clactanodonombre),'') from cont_clasificacuentas        where ppdcid = $pdcid
        ...
        and clactanivel5 = (select clactanivel5 from cont_clasificacuentas where pctaid = test_Movimientos.pCtaId and ppdcid = $pdcid )
        and clactanivel6 = (select clactanivel6 from cont_clasificacuentas where pctaid = test_Movimientos.pCtaId and ppdcid = $pdcid )
        and clactanivel7 = (select clactanivel7 from cont_clasificacuentas where pctaid = test_Movimientos.pCtaId and ppdcid = $pdcid )
        and (pctaid = 0 or pctaid = test_Movimientos.pCtaId)
        and clactanodonivel = 7 )
        as clactanodonivel7
