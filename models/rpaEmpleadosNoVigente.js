...
var rpaEmpleadosNoVigente = sequelize.define('rpaEmpleadosNoVigente', {
    idEmpleado: {
        type: type.INTEGER,
        primaryKey: true,
        autoIncrement: true
    },
    rut: { type: type.STRING, unique: 'rpaEmpleadoNoVigente_Index1' } ,
    comuna: type.STRING,
    fecha: type.STRING,
...
module.exports = rpaEmpleadosNoVigente;