...
router.get("/index", middleware.isLoggedIn, function (req, res) {
    ...
    leeSolicitudes(req.session.idUsuario)
        .then(data => {
            if (!isMobile) {
                res.render("solicitudes/index", { data: data });
            } else {
                res.render("solicitudes/indexMobile", { data: data });
            }
                    ...
                    .then(areas=>{
                        ...
                        .then(reemplazados=>{
                            ...
                            .then(estados=>{
                                ...
                                let isMobile = req.session.isMobile
                                if (!isMobile) {
                                    res.render("solicitudes/new", { data: data, 
                                        motivos: motivos,
                                        cargos: cargos,
                                    ...
                                    res.render("solicitudes/newMobile", { data: data, 
                                        motivos: motivos,
                                        cargos: cargos,
                                        reemplazantes: reemplazantes, 
                                        areas: areas,
...
// Enviar
            res.redirect("/solicitudes/index");
        })
        .catch(err => {console.log(err)})
});
                    ...
                    .then(reemplazados=>{
                        ...
                        .then(estados=>{
                            if (!req.session.isMobile) {
                                res.render("solicitudes/edit", { data: data, 
                                    motivos: motivos,
                                    cargos: cargos,
                                    reemplazantes: reemplazantes, 
                                    areas: areas,
                                ...
                                res.render("solicitudes/editMobile", { data: data, 
                                    motivos: motivos,
                                    cargos: cargos,
                                    reemplazantes: reemplazantes, 
                                    areas: areas,
            ...
            .then(reemplazantes=>{
                ...
                .then(areas=>{
                    ...
                    .then(reemplazados=>{
                        ...
                        .then(estados=>{
                            if (!req.session.isMobile) {
                                res.render("solicitudes/delete", { data: data, 
                                    motivos: motivos,
                                    cargos: cargos,
                                    reemplazantes: reemplazantes, 
                                    areas: areas,
                                ...
                                res.render("solicitudes/deleteMobile", { data: data, 
                                    motivos: motivos,
                                    cargos: cargos,
                                    reemplazantes: reemplazantes, 
                                    areas: areas,
            ...
            .then(reemplazantes=>{
                ...
                .then(areas=>{
                    ...
                    .then(reemplazados=>{
                        ...
                        .then(estados=>{
                            if (!req.session.isMobile) {
                                res.render("solicitudes/enviar", { data: data, 
                                    motivos: motivos,
                                    cargos: cargos,
                                    reemplazantes: reemplazantes, 
                                    areas: areas,
                                ...
                                res.render("solicitudes/enviarMobile", { data: data, 
                                    motivos: motivos,
                                    cargos: cargos,
                                    reemplazantes: reemplazantes, 
                                    areas: areas,
...
//router.get("/aprobar/:id", middleware.isLoggedInAprobar, async function (req, res) {
router.get("/aprobar/:id", async function (req, res) {    
    ...
    if (dataSolicitud.estado==2) {
        ...
        var texto=t
        await enviaCorreo(destinatarios, "Se ha aprobado la Solicitud Nro. " + data.idSolicitud, texto)
        ...
        res.render("solicitudes/aprobadoNew", {mensaje: mensaje});
    } else {
            ...
            .then(reemplazantes=>{
                ...
                .then(areas=>{
                    ...
                    .then(reemplazados=>{
                        ...
                        .then(estados=>{
                            if (!req.session.isMobile) {
                                res.render("solicitudes/confirmar", { data: data, 
                                    motivos: motivos,
                                    cargos: cargos,
                                    reemplazantes: reemplazantes, 
                                    areas: areas,
                                ...
                                res.render("solicitudes/confirmarMobile", { data: data, 
                                    motivos: motivos,
                                    cargos: cargos,
                                    reemplazantes: reemplazantes, 
                                    areas: areas,
...
var leeSolicitudes = function (idUsuario) {
    return new Promise(function (resolve, reject) {
        ...
        sql += "       solicitudesEstados g on g.codigo = a.estado join "
        sql += "       bukAreas h on h.idBuk = a.idArea "
        sql += " where a.idUsuarioSolicitante = " + idUsuario 
...
var leeCargosUsuario = function (idUsuario) {
    return new Promise(function (resolve, reject) {
        ...
        sql += "        usuarioCargos b on a.idCargo = b.idCargo join "
        sql += "        bukPersonas c on c.Name = a.nombre "
        sql += "  where b.idUsuario = " + idUsuario
        sql += "    and c.status = 'activo'"
        sql += "   group by a.idCargo, a.nombre "
